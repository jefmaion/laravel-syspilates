...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1> <i class="fa fa-users" aria-hidden="true"></i> <strong>Editar Aula</strong> - {{
...
<div class="row">
    ...
    <div class="col-4">
        <form action="{{ route('student.registration.class.update', [$student, $registration, $class]) }}" method="post">
